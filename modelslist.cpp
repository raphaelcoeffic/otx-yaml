...
// void ModelCell::save(FILE* file)
// {
//     fwrite(modelFilename, strlen(modelFilename), 1, file);
//     fwrite("\n", sizeof("\n"), 1, file);
// }
...
// void ModelsCategory::save(FILE * file)
// {
...
//     }
// }
void ModelsCategory::dump()
{
    TRACE("# category: name=<%s>\n", name);
    for (list<ModelCell *>::iterator it = begin(); it != end(); ++it) {
        (*it)->dump();
    }
}
